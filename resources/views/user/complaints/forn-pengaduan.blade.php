                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12 mb-3">
                                        <div    class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" disabled enabled value="{{auth()->user()->name }}" placeholder="Nama Lengkap" name="name" required>
                                            @error('name')
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="telp" class="form-control @error('telp') is-invalid @enderror" disabled enabled value="{{auth()->user()->telp }}"  placeholder="Nomor Telepon" name="telp" required>
                                            @error('telp')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="image" class="form-control @error('email') is-invalid @enderror" name="image" placeholder="Image" required>
                                            @error('image')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" disabled enabled value="{{auth()->user()->email }}" placeholder="Alamat Email" name="email" required>
                                            @error('email')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
