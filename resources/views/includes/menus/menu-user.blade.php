<li class="sidebar-item active {{ request()->routeIs('user.index') ? 'active' : '' }} ">
...
<li
     class="sidebar-item has-sub has-sub {{ request()->routeIs('user.all.complaints') ||  request()->routeIs('user.all.pending.complaints')|| request()->routeIs('user.all.process.complaints')|| request()->routeIs('user.all.success.complaints') ? 'active' : '' }}">
