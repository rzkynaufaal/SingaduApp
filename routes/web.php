...
Route::prefix('admin')->middleware(['auth', 'isAdmin'])->group(function(){
    ...
    Route::post('/complaint-reponse',[AdminController::class, 'storeResponse'])->name( 'admin.complaint.response');
});
...
Route::prefix('user')->middleware(['auth','isUser'])->group(function() {
    ...
    Route::get('/all-done-complaints',[UserComplaintController::class, 'allDoneUserComplaints'])->name( 'user.all.success.complaints');
});
